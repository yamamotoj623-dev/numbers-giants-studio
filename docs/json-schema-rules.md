# JSON Gem 詳細ルール集 (json-schema-rules.md)

★ JSON Gem の Knowledge File として参照される。スキーマ詳細・数値整形・配分ルール・出力前チェックを集約。
...
| キー | 値 |
|---|---|
| layoutType | `radar_compare\|timeline\|ranking\|versus_card\|player_spotlight\|pitch_arsenal\|team_context\|batter_heatmap` |
...
### 一般語・野球用語は漢字維持(TTS が正しく読める)
打者 / 投手 / 先発 / 中継ぎ / 抑え / 打席 / 打線 / 先頭 / 援護 / 奪三振 / 四球 / 安打 / 本塁打 / 守備 / 被打率 / 勝利 / 敗戦
打つ / 投げる / 抑える / 示す / 続ける / 見せる / 狙う
...
□ 列挙値が範囲内(textSize=xl/l/m/s、scenePreset=指定 7 種、layoutType=指定 8 種)
