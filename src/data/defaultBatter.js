...
export const defaultBatterData = {
  ...
  layoutData: {
    timeline: {
      ...
      metric: 'IsoP',
      points: [
        { label: '4月', main: 0.095, sub: 0.092, highlight: false },
        { label: '5月', main: 0.110, sub: 0.098, highlight: false },
        { label: '6月', main: 0.150, sub: 0.095, highlight: false },
  ...
  scripts: [
    ...
    // ===== ハイライト2: IsoD (★ここでtimeline切替) =====
    { id: 14, speaker: 'A', emoji: '👨‍🏫', layoutType: 'timeline', text: '出塁力を測る\n「IsoD」を見ます', speech: '出塁力を測るアイソディーを見ます。', highlight: 'isod', textSize: 'm', se: 'transition_swoosh' },
    ...
    // ===== アウトロ (二択疑問でブツ切り) =====
    { id: 34, speaker: 'A', emoji: '👨‍🏫', text: '今季の本塁打\n何本予想?', speech: '今季の本塁打何本予想。', highlight: null, textSize: 'm', se: null },
    { id: 35, speaker: 'B', emoji: '🤔', text: '【10本?\n20本?】', speech: 'じゅっぽんか。にじゅっぽんか。', highlight: null, textSize: 'l', se: 'outro_fade' },
  ]
};
