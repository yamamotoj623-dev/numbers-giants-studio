    ...
    <div key={`zoom-${animationKey}`} className="flex-1 flex flex-col justify-start relative z-10 w-full pt-12 pb-[30%] px-3">
      ...
      <div className="mt-8 mb-2 bg-zinc-900/90 rounded-xl border border-zinc-700/50 overflow-hidden shadow-2xl backdrop-blur-sm z-20">
        <div className="px-3 py-2 border-b border-zinc-700/80 bg-zinc-800/30 flex items-center justify-between">
          <span className={`${themeClass.text} text-[12px] font-black`}>{title}</span>
          <span className="text-zinc-500 text-[13px] font-bold">高: ↑ / 低: ↓</span>
        </div>

        <div className="p-3 flex items-center justify-center relative">
          <div className="absolute left-1 top-8 text-[13px] font-bold text-zinc-500">高</div>
          <div className="absolute left-1 top-1/2 -translate-y-1/2 text-[13px] font-bold text-zinc-500">中</div>
          <div className="absolute left-1 bottom-4 text-[13px] font-bold text-zinc-500">低</div>
          <div className="absolute bottom-0 left-1/2 -translate-x-1/2 text-[13px] font-bold text-zinc-500 px-8 flex justify-between w-full">
        ...
        <div className="flex items-center justify-between px-3 py-1.5 bg-zinc-800/50 border-t border-zinc-700/50 text-[13px] font-bold text-zinc-400">
