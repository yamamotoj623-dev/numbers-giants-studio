...
const CSS_TEXT = `
  ...
  * { box-sizing: border-box; -webkit-font-smoothing: antialiased; margin: 0; padding: 0; }
  ...
  .telop-wrap-normal { position: absolute; bottom: 19%; left: 0; right: 0; display: flex; flex-direction: column; z-index: 30; pointer-events: none; padding: 0 14px; }
  .telop-wrap-hl { position: absolute; bottom: 20%; left: 0; right: 0; display: flex; flex-direction: column; z-index: 30; pointer-events: none; padding: 0 14px; }
  ...
  .telop-wrap-hl { position: absolute; bottom: 15%; left: 0; right: 0; display: flex; flex-direction: column; align-items: center; padding: 0 72px; z-index: 30; pointer-events: none; }
