...
・id:3〜17: 誤信→データで覆す→納得→改善展望
  各highlightは B が「実はコレが問題なんです」的に切り出したタイミングで発動
・id:18: ポジティブ展望で締める
・id:19（A / フェーズD開始）: 具体数字・選択肢で視聴者に問いかけ
・id:20（B / フェーズD終端）: Bが自分の予測を先に言って視聴者を煽る＋チャンネル登録促進
...
・末尾のCTA（id:19-20）では具体的な問いかけで「コメントしたい」を誘発
